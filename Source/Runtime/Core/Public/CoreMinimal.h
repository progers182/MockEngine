...
#define TEXT(str) std::string(str)
...
class FVector : public UObject {
	...
	FVector operator+(const FVector& o ) const {return FVector(this->X+o.X, this->Y+o.Y, this->Z+o.Z);}
	FVector operator-(const FVector& o ) const {return FVector(this->X-o.X, this->Y-o.Y, this->Z-o.Z);}
	FVector operator*(const FVector& o ) const {return FVector(this->X*o.X, this->Y*o.Y, this->Z*o.Z);}
	FVector operator/(const FVector& o ) const {return FVector(this->X/o.X, this->Y/o.Y, this->Z/o.Z);}
	...
	FVector operator=(const FVector& o ) const {return FVector(o.X, o.Y, o.Z);}
};
