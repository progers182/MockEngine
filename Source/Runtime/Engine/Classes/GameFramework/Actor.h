...
struct FActorTickFunction {
	...
	char bHighPriority=1;
	char bRunOnAnyThread=1;
	float TickInterval;
};
...
public:
	...
	char bCallPreReplication:1;
	char bCallPreReplicationForReplay:1;
	char bHidden:1;
	char bTearOff:1;
	char bForceNetAddressable:1;
	char bIsInEditingLevelInstance:1;
	...
	char bNetCheckedInitialPhysicsState : 1;
	char bHasFinishedSpawning:1;
	char bActorInitialized:1;
	char bActorBeginningPlayFromLevelStreaming:1;
	char bTickFunctionsRegistered:1;
	char bHasDeferredComponentRegistration:1;
	char bRunningUserConstructionScript:1;
	char bActorEnableCollision:1;
	char bActorIsBeingDestroyed:1;
	char bActorWantsDestroyDuringBeginPlay : 1;
	char bHiddenEd:1;
	char bIsEditorPreviewActor:1;
	char bHiddenEdLayer:1;
	char bHiddenEdLevel:1;
	char bRunConstructionScriptOnDrag:1;
	char bDefaultOutlinerExpansionState : 1;
	char bLockLocation:1;
	char bActorLabelEditable:1;
	char bEditable:1;
	char bListedInSceneOutliner:1;
	char bOptimizeBPComponentData:1;
	char bCanPlayFromHere : 1;
	char bIsSpatiallyLoaded : 1;
	char bHiddenEdTemporary:1;
	char bForceExternalActorLevelReferenceForPIE : 1;
	char bActorIsBeingConstructed : 1;
};
